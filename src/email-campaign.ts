...
const messages: Record<string, string> = {
  ...
  email_beta_mailbox_use_required: "Say whether this is a mailbox you already use or a new account for outreach before sending. Reconnect the email account to answer.",
  ...
  email_warmup_required: "This new outreach account needs 21 active warmup days and a healthy check from the last 24 hours before it can send. Check progress with lifty email warmup status.",
